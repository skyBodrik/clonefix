...
public class GetClassInheritElementVisitor implements GenericVisitor<String, Map<String, String>> {
    ...
    public String visit(MethodDeclaration methodDeclaration, Map<String, String> stringStringMap) {
        return null;
    }
